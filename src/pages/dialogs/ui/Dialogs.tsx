...
import { LoaderContainer } from "../../chat/ui/ChatStyled"
import { dialogsThunks } from "../model/dialogsThunk"
...
export const Dialogs: FC<{}> = React.memo(({}) => {
  ...
  const { fetchDialogs, addMessage, deleteMessage, fetchMessages } = useActions({ ...dialogsThunks })
  ...
  return (
    <DialogsStyled>
      ...
      {!!userMessageId ? (
        <Dialog id={userMessageId} addNewMessage={addMessageHandler} deleteMessage={deleteMessageHandler} />
      ) : (
